...
public class DashboardPeriodTotal {
    ...
    public DashboardPeriodTotal(List<DashboardPeriodAmount> today, List<DashboardPeriodAmount> thisWeek, List<DashboardPeriodAmount> thisMonth, List<DashboardPeriodAmount> thisYear) {
        todayData = today;
